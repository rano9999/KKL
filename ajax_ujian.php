...
elseif($_GET['action']=="selesai_ujian"){
   ...
   mysqli_query($mysqli, "UPDATE nilai SET  nilaiD='$jumlahD', nilaiI='$jumlahI', nilaiS='$jumlahS', nilaiC='$jumlahC', kategori='$kategori', periode = '$tahun[periode]' WHERE nim='$_SESSION[nim]'");
   
   mysqli_query($mysqli, "UPDATE siswa SET tanda='login' WHERE nim='$_SESSION[nim]'");
