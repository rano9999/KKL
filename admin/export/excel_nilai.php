...
$excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA NILAI PSIKOTES MAHASISWA STMIK AMIKOM PURWOKERTO PERIODE ".$periode['periode']);
...
while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
	...
	$excel->setActiveSheetIndex(0)->setCellValueExplicit('F'.$numrow, $data['nilaiI'], PHPExcel_Cell_DataType::TYPE_STRING);
...
$excel->getActiveSheet(0)->setTitle("Laporan Nilai Mahasiswa");
