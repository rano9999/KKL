...
$ulangD = mysqli_query($mysqli, "SELECT * FROM nilai, siswa WHERE nilai.nim = siswa.nim AND siswa.validasi = 'Valid' AND nilai.kategori = '$kat' AND status = 'belum' ORDER BY nilaiI DESC LIMIT $kurang");
