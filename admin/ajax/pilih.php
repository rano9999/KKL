...
$cekS = mysqli_query($mysqli, "SELECT * FROM nilai, siswa WHERE nilai.nim = siswa.nim AND nilai.periode = '$cek[periode]' AND nilai.kategori = 'Steadiness' ORDER BY nilai.nilaiS, siswa.keaktifan DESC LIMIT 4");
