...
mysqli_query($mysqli, "UPDATE siswa SET status='mengerjakan' WHERE nim='$_SESSION[nim]'");

$rujian = mysqli_fetch_array(mysqli_query($mysqli, "SELECT * FROM ujian"));
...
if(mysqli_num_rows($qnilai) < 1){
   mysqli_query($mysqli, "INSERT INTO nilai SET nim='$_SESSION[nim]', acak_soal='$acak_soal', jawaban='$jawaban', sisa_waktu='$rujian[waktu]:00'");
}
...
<div class="modal-body">
   ...
   <div class="chekbox-selesai"><label for=""><input type="checkbox" required> Saya yakin telah menyelesaikan ujian.</label></div>
</div>
